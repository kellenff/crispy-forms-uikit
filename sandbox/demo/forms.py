...
# from crispy_forms_uikit.layout import Layout, Fieldset, TabItem, TabHolder, AccordionHolder, AccordionItem
from crispy_forms_uikit.layout import Layout
from .crispies import (part_1_crispies, part_3_crispies, buttons_crispies)
# , part_2_crispies, part_3_crispies,
...
class BaseForm(forms.Form):
    ...
    """
    full_input = forms.CharField(label=_('Full width input'),
